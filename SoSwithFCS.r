...
sumTable <- aggregate(cbind(Adjusted.SoS, SoS.Score, SoS.Ranking) ~ Conference, data = records, sum)
countTable <- aggregate(cbind(Adjusted.SoS, SoS.Score, SoS.Ranking) ~ Conference, data = records, length)
